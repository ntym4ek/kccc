...
<article class="card blog clearfix"<?php print $attributes; ?>>
    ...
    <footer>
        ...
        <?php if (!empty($place)): ?><div class="<? $type == 'vacancy' ? 'wide-side' : 'right-side'; ?>"><a title="Расположение"><i class="fas fa-location-arrow"></i><span><?php print $place; ?></span></a></div><?php endif; ?>
