...
<div class="v-card product">
    <div class="v-card-image">
        <a href="<?php print $product_url; ?>" title="<?php print $title; ?>">
    ...
    <div class="v-card-content">
        ...
        <div class="v-card-summary">
            <div class="v-card-subtitle"></div>
            <div><?php print $content['body'][0]['#markup']; ?></div>
        </div>
        <a class="btn btn-primary v-card-more" href="<?php print $product_url; ?>" title="<?php print $title; ?>">
            <?php print t('More'); ?>
    ...
    <footer>
        <?php if (!empty($content['field_pd_price_per_unit']['#items'][0]['amount'])): ?>
            <?php print '<strong>' . t('Price per unit') . '</strong> ' . t('(with NDS)') . ': ' . $content['field_pd_price_per_unit'][0]['#markup']; ?>
        <?php endif; ?>
    </footer>
</div>
