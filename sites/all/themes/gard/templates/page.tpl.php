...
<header id="navbar" role="banner" class="navbar hidden-print">
    ...
    <div class="right-menu">
      <div class="btn btn-header popup-trigger btn-s3 right-menu-links">
        <div><span class="link-header-black">Телефон</span></div>
        <div><a class="link-header-black" href="tel:<? print $reception_phone; ?>"><? print $reception_phone_formatted; ?></a></div>

      </div>
        <?php print render($secondary_nav); ?>
        <button type="button" class="btn btn-header popup-trigger btn-s2 call_back_post">
          <img src="/sites/all/themes/gard/images/icons/phone_d.png" alt="Позвонить <? print $site_name; ?>">
        ...
        <a href="<?php print url('/checkout'); ?>" class="btn btn-header popup-trigger btn-s3" rel="nofollow">
          <img src="/sites/all/themes/gard/images/icons/cart_d.png" alt="Корзина"><?php print ext_checkout_get_cart_block(); ?></i>
                        ...
                        <?php if (!empty($header['url'])): ?>
                            <div class="header-share closed">
                                <div class="social-links">
                                    <a class="vk" href="https://vk.com/share.php?url=<?php print $header['url']; ?>" rel="nofollow" target="_blank" title="вконтакте"><i class="fab fa-vk" aria-hidden="true"></i></a>
        ...
        <footer class="footer hidden-print">
                ...
                <div class="col-sm-7 col-md-8">
                    <div class="row">
                        <div class="col-xs-12">
                          <div class="row">
                            <div class="col-xs-12 col-md-6 hidden-xs"><?php print $site_slogan; ?></div>
