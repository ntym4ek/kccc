...
/** небольшие изменения на базе оригинальной функции bootstrap_form_element_label */
function gard_form_element_label(array &$variables)
{
  ...
  if ($checkbox || $radio) {
    if ($display === 'before') {
      $output .= '<span class="cb-text">' . $title . '</span>';
    }
