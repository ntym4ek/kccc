 ...
 */
function gard_webform_element(&$variables) {
  ...
  // If field prefix or suffix is present, make this an input group.
    // из-за префикса form-input-wrapper в gard_pre_render добавляется элемент с input-group-addon и добавляет серый фон
