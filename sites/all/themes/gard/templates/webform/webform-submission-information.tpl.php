 ...
 */
?>
<fieldset class="webform-submission-info panel panel-default">
  <legend class="panel-heading">
      <span class="panel-title fieldset-legend"><?php print t('Submission information'); ?></span>
  </legend>
  <?php print theme('user_picture', array('account' => $account)); ?>
  <div class="webform-submission-info-text panel-body">
