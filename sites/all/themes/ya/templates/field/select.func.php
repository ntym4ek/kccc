 ...
 * @ingroup themeable
 */
function ya_select($variables)
{
    $element = $variables['element'];
    element_set_attributes($element, array('id', 'name', 'size'));
    _form_set_class($element, array('form-select'));

    return '<select' . drupal_attributes($element['#attributes']) . '>' . ya_form_select_options($element) . '</select>';
}
 ...
 */
function ya_form_select_options($element, $choices = NULL)
{
    if (!isset($choices)) {
