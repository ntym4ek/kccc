 ...
 */
?>
<article class="teaser <? print $type; ?> clearfix"<?php print $attributes; ?>>
  <div class="top">
    <? if (!empty($category_title)): ?>
      <a href="<? print $category_url; ?>" class="btn btn-clear category"><? print $category_title; ?></a>
    <? endif; ?>
    <? if (!empty($employer)): ?>
      <a href="#" class="btn btn-clear category"><? print $employer; ?></a>
    <? endif; ?>
