    ...
    <div class="protection-program">
      <?php if (isset($program['categories'])): ?>
        ...
        <?php foreach($program['categories'] as $key_cat => $category): ?>
          <div class="row">
            <div class="col-xs-12 ">
              <div id="category-<?php print $category['tid']; ?>" class="list-category-header category-<?php print $category['tid']; ?><?php print empty($category['cnt']) ? "" : " is-active"; ?>" data-toggle="collapse" data-cnt="<?php print empty($category['cnt']) ? '0' : $category['cnt']; ?>" href="#collapse-<?php print $category['tid']; ?>" aria-expanded="true" aria-controls="collapse-<?php print $category['tid']; ?>">
                <!--                                <div class="bkg"><img src="--><?php //print $category['bkg_desk']; ?><!--" alt="--><?php //print $category['name']; ?><!--"></div>-->
                <div class="icon"><img class="img-responsive" src="<?php print $category['icon']; ?>" alt="help icon"></div>
                ...
                <?php foreach($stage as $key_set => $set): ?>
                  <?php foreach($set as $key_reg => $reglament): ?>
                    ...
                    <div class="view-item col-xs-12 col-sm-6 col-md-4">
                      ...
                      <?php endif; ?>
                      <div class="card product-card reglament gray<?php print $reglament['state'] == 'on' ? " is-active" : ""; ?>" data-cat="category-<?php print $category['tid']; ?>" id="<?php print $key_cat . '_' . $key_stage . '_' . $key_set . '_' . $key_reg; ?>">
                        <?php if ($area): ?>
                        ...
                        <div class="card-content">
                          ...
                          <div class="card-title">
                            <h3><a href="<?php print $product_url; ?>" target="_blank"><?php print $title; ?></a></h3>
                          </div>
                          <?php if (!empty($reglament['preparations']['ingredients'])): ?>
                            <div class="card-subtitle"><?php print $reglament['preparations']['ingredients']; ?></div>
                          <?php endif; ?>
        ...
        <?php if ($area): ?>
          <div class="row">
            <div class="col-xs-12">
              <div class="list-category-header calculation-total category-17">
