    ...
    <div class="forum-post-wrapper">
        ...
        <div class="forum-post-footer">
            <div class="forum-jump-links">
                <a href="#forum-topic-top" title="<?php print t('Jump to top of page'); ?>" class="af-button-small"><i class="fa fa-arrow-up" aria-hidden="true"></i></a>
            </div>
            ...
            <div class="forum-post-info">
                <span class="forum-posted-on">
                    ...
                    <?php if (!$top_post): ?>
                        <?php if (!empty($new)): ?>
                            <span id="new" class="marker label label-info">новое</span>
                        <?php endif; ?>
