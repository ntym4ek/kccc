      ...
      <table class="forum-table forum-table-forums">
        <thead class="forum-header">
          <tr>
            ...
            <th class="forum-last-post" colspan="2"><?php print t('Last post'); ?></th>
          </tr>
        </thead>
            ...
            <?php if ($item->is_container): ?>
              ...
              <?php else: ?>
                <td class="<?php print $item->icon_classes ?>">
                  <span class="forum-list-icon-wrapper"><span class="icon"><?php print $item->icon_text ?></span></span>
                </td>
              <?php endif; ?>
