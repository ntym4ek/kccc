  ...
  <div class="bg">
    <div class="today">
      <div class="info">
        ...
        <span style="font-size:24px;"><?php print t('Agrocast'); ?></span><br />
                ...
                <?php foreach ($day['day_part'] as $key2 => $day_part): ?>
                  <?php if( $key2 < 4 ):?>
                    <div class="day_part">
                      ...
                      <div class="temp">
                        <?php if( $day_part['temp'] ):?>
                          <?php print $day_part['temp']; ?>
                        <?php else: ?>
                          <?php print $day_part['temp_from'] . '&deg;/' . $day_part['temp_to'] . '&deg;'; ?>
                        <?php endif; ?> 
                      </div>
                    </div>
                  <?php endif; ?>
