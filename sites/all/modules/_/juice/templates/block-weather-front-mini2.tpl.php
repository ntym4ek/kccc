<div class="weather front block_1_1">
  <div class="bg">
    <?php if ( isset( $forecast['fact'] )) :?>
    <div class="today">
      <div class="info">
        <span><a href="info/agrocast" target="_blank"><?php print t('Agrocast'); ?></a></span><br />
    ...
    <div class="disclaimer">
        <?php print t('This forecast for acquaintance only'); ?>
    </div>  
  <?php else: ?>
        <?php print t('Refresh the page to get forecast'); ?>
  <?php endif; ?>
  </div>
</div>
