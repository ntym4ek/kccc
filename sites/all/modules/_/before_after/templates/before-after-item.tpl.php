    ...
    <div class="v-card field">
        ...
        <div class="v-card-image">
            <a href="<?php print $content['link']; ?>">
                <img src="<?php print $content['image_thumb']; ?>" class="img-responsive" title="Действие препарата в поле" alt="Защита культуры <?php print $content['culture'] . '. ' . $content['region']; ?>">
            </a>
        </div>
