...
<div class="block-trade-net">

  <div class="screen-width">
    <div class="section-title invert">
      <div><?php print t('Trade net'); ?></div>
  ...
  <div class="row">
    ...
    <div class="col-xs-12 col-md-6 col-lg-7">
      <div class="map">
        <img src="/sites/all/modules/custom/ext_block/images/map2.jpg" alt="<?php print t('TH «KCCC» LLC trade net'); ?>">
      </div>
    </div>
  </div>
